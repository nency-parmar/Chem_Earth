              ...
              child: Column(
                children: [
                  ...
                  Obx(() => _buildStatusCard(
                        'Current Status',
                        controller.microphoneStatusText,
                        controller.isMicrophoneGranted,
                        Icons.info_outline,
                        isDark,
                        theme,
                      )),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (controller.microphonePermissionStatus == PermissionStatus.permanentlyDenied)
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                icon: Icon(
                  controller.isMicrophoneGranted ? Icons.check : Icons.mic,
                ),
                label: Text(
                  controller.isMicrophoneGranted 
                      ? 'Permission Granted' 
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: controller.isMicrophoneGranted 
                      ? Colors.green 
                      : Colors.blueGrey,
                  foregroundColor: Colors.white,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInstructionStep(
            '2.',
            'Allow microphone access in the system dialog',
            isDark,
            theme,
          ),
          const SizedBox(height: 12),
          _buildInstructionStep(
            '3.',
            'Start using voice features in the app',
            isDark,
            theme,
          ),
          const SizedBox(height: 16),
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Tip: You can always change this permission later in your device settings.',
