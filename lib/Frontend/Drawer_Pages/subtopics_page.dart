...
class _SubTopicsPageState extends State<SubTopicsPage>
  ...
  Future<void> _loadSubTopics() async {
    try {
      final subTopicsData = await _dbHelper.getSubTopics(widget.topic['TopicID']);
      setState(() {
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                subTopic['SubTopicName'] ?? 'Unknown Subtopic',
                                style: TextStyle(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          subTopic['SubTopicName'] ?? 'Subtopic Details',
                          style: TextStyle(
                            fontSize: 24,
                            fontWeight: FontWeight.bold,
                            color: isDark ? Colors.white : Colors.black,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          subTopic['Remarks'] ?? 'This subtopic covers important concepts and detailed explanations of the subject matter.',
                          style: TextStyle(
                            fontSize: 16,
  ...
  void _navigateToQuiz() {
    // Navigate to quiz topic selection page
